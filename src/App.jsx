...
function App() {
 ...
 useEffect(()=>{
  ...
  return (
    <>
    <dialog ref={dialog} >
      <button onClick={ ()=>navigator.clipboard.writeText(JSON.stringify(arrayPlaces,null,2))}>Copy Data<ClipboardCopy strokeWidth={3}/></button>
      <button onClick={()=>{dialog.current&&dialog.current.close()}}>Close</button>
    </dialog>
